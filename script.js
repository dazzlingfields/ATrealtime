...
// ================== v5.4 - Real-time Vehicle Tracking (Viewport Optimized) ==================
...
// Fetch vehicles (only in current map view)
...
// Load bus types and start updating vehicles
(async function init(){
    await loadBusTypes();
    fetchVehicles();
